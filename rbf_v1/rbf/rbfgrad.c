    ...
    mexFuncConst Matrix *prhs[])
{
  ...
  h1_sigma_sigma=mxGetPr(prhs[8]) ; assert(h1_sigma_sigma!=0) ;
  /*printf("(%i,%i)\n", mxGetM(prhs[8]), mxGetN(prhs[8])) ;*/
  h2_sigma_sigma=mxGetPr(prhs[9]) ; assert(h2_sigma_sigma!=0) ;
  /*printf("(%i,%i)\n", mxGetM(prhs[9]), mxGetN(prhs[9])) ;*/
  dif_h1_h1=mxGetPr(prhs[10]) ; assert(dif_h1_h1!=0) ;
  /*printf("(%i,%i)\n", mxGetM(prhs[10]), mxGetN(prhs[10])) ;*/
  dif_h2_h2=mxGetPr(prhs[11]) ; assert(dif_h2_h2!=0) ;
  ...
  if ((mxGetM(prhs[8])!=1) | (mxGetN(prhs[8])!=m))
  {
  ...
  rbfgrad(X, Y, O, mu, sigma, w, H, Inp,
